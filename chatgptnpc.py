...
class ChatGPTNPC:
  def __init__(self, name, voice):
    ...
    Args:
      name (str): O nome do NPC.
      voice (str): A Voz do NPC.
  ...
  def getVoice(self):
    """
    Retorna a voz do NPC.
    """
    return self.voice

  def hasLocation(self):
    """
    Retorna True se o NPC tem uma localização, False se não.
    """
    return self.location != ""

  def getLocation(self):
    """
    Retorna a localização do NPC.

    Returns:
    str: A localização do NPC
    """
    return self.location
  
  def setLocation(self, location):
    """
    Seta a localização do NPC para uma localização específica.

    Args:
      location (str): O nome da localização para assign the NPC to.
